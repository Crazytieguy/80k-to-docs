...
- Execute recurring administrative tasks maintaining 100% data accuracy in recruitment trackers.
- Facilitate candidate screening through CV longlisting, interview scheduling, and professional communication.
- Maintain the Applicant Tracking System database, update applicant statuses, and extract data for reporting.
- Manage logistics for interview panels and support process improvements with your manager.
